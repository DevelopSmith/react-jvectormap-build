...
export type GetOffsets = (code: string) => {
...
export type OnRegionTipShow = (event: JQuery.Event, el: Element, code: string) => void;
export type SelectedEntities = string[] | {
    [region: string]: boolean;
} | string;
export {};
